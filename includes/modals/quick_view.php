                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="ps-lg-8 mt-6 mt-lg-0">
                            <h2 class="mb-1 h1">Chinese Cabbage</h2>
                            <div class="fs-4">
                                <span class="fw-bold text-dark">₦132</span>
                                <span class="text-decoration-line-through text-muted">₦135</span>
                            ...
                            <div>
                                ...
                                <div class="input-group input-spinner">
                                    <input type="button" value="-" class="button-minus btn btn-sm btn-secondary text-dark rounded-start-pill" data-field="quantity" />
                                    <input type="number" step="1" max="10" value="1" name="quantity" class="quantity-field form-control-sm form-input" />
                                    <input type="button" value="+" class="button-plus btn btn-sm btn-secondary text-dark rounded-end-pill" data-field="quantity" />
                                </div>
                            </div>
                            <div class="mt-3 row justify-content-start g-2 align-items-center">
                                ...
                                <div class="col-md-4 col-5">
                                    <!-- btn -->
                                    <a class="btn btn-outline-primary" href="#!" data-bs-toggle="tooltip" data-bs-html="true" aria-label="Wishlist"><i class="feather-icon icon-heart"></i></a>
                                </div>
                            </div>
                            <hr class="my-6" />
                            <p class="">Category: <span class="text-muted">Vegetables</span></p>
                        </div>
                    </div>
                </div>
            </div>
